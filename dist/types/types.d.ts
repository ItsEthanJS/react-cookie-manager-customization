...
export type TranslationKey =
  ...
  /**
   * Title for Preferences cookies in manage cookies view
   * @default 'Preferences'
   */
  | "managePreferencesTitle"
  /**
   * Subtitle for Preferences cookies in manage cookies view
   * @default 'Enable website Preferences such as Light and Dark Mode'
   */
...
export interface CookieConsenterProps {
   ...
   * @default { Analytics: false, Preferences: false, Advertising: false }
   */
   ...
   * @default { Analytics: true, Preferences: true, Advertising: true }
   */
